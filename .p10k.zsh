...
# intro {{{
# Generated by Powerlevel10k configuration wizard on 2020-02-04 at 12:30 PST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 25932.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    nodenv_custom                  # node.js version from nodenv (https://github.com/nodenv/nodenv)
...
# time: current time {{{
  ...
  # strangely the default plugin doesn't show up on easel for me :/
  function prompt_nodenv_custom() {
    p10k segment -f 034 -i '' -t "$(nodenv local 2>/dev/null)" -c "$(nodenv local 2>/dev/null)"
  }
